...
which prevents acceptance of updates on CRAN or on Bioconductor. In general, we
...
2. If a heavy suggested package is only used in examples and vignettes.
   Developers may think whether they really need the corresponding code to run
   ...
   e.g., [the Seurat package](https://satijalab.org/seurat/).
